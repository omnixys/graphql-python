<!-- repository: packages/python/graphql | kind: PACKAGE | stack: python-package -->

# graphql

> Repository development instructions for **graphql** (Shared Package).
> Stack: python-package. Generated as part of the Omnixys repository-policy rollout.

## Repository Overview

Omnixys shared GraphQL package (Apollo Federation, error handling, pagination).

- Repository path: `packages/python/graphql` (relative to the Omnixys root)
...
GraphQL contract helpers consumed by Strawberry-based services.
