...
# graphql — Skill: Package Development

> Workflow for graphql (packages/python/graphql). Execute this workflow before, during, and
...
- This package is published (`omnixys-graphql`); consumers pin versions and rely on SemVer.
